...
# на свою экранированную форму. Через str.translate операция выполняется
# одним проходом по строке и автоматически снимает проблему порядка
# (в отличие от цепочки .replace, где бэкслеш нужно экранировать первым).
